...
func (at *AutoTrader) InitializeGrid() error {
	...
	if gridConfig.UseATRBounds {
		...
		mktData, err := market.GetWithTimeframes(gridConfig.Symbol, []string{"4h"}, "4h", map[string]int{"4h": 20}, nil)
		if err != nil {
...
func (at *AutoTrader) buildGridContext() (*kernel.GridContext, error) {
	...
	// Get market data
	mktData, err := market.GetWithTimeframes(gridConfig.Symbol, []string{"5m", "4h"}, "5m", map[string]int{"5m": 50, "4h": 20}, nil)
	if err != nil {
