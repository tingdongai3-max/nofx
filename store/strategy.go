...
const DefaultCandleCloseOffset = 5 * time.Second
const MemoryFactor = 2.5
...
type IndicatorConfig struct {
	...
	EnableDonchianBox bool `json:"enable_donchian_box"` // Donchian box trend filter factor
	...
	// Donchian box period configuration (trend filter factor)
	DonchianPeriods []int `json:"donchian_periods,omitempty"` // default [72, 240, 500]
