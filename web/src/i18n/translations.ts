...
export const translations = {
  en: {
    ...
    positionHistory: {
      ...
      lev: 'Lev',
      pnl: 'P&L',
      maxProfit: 'Max Profit (MFE)',
      maxLoss: 'Max Loss (MAE)',
      duration: 'Duration',
      closedAt: 'Closed At',
    },
    ...
    // Trader Admin
    traderAdmins: 'Trader Administrators',
    createAdmin: 'Create Admin',
    editAdmin: 'Edit Administrator',
    adminName: 'Administrator Name',
    enterAdminName: 'Enter administrator name',
    scanInterval: 'Scan Interval',
    managedTraders: 'Managed Traders',
    selectAll: 'Select All',
    deselectAll: 'Deselect All',
    noTradersAvailable: 'No traders available',
    selectedCount: 'Selected',
    failedToLoadTraders: 'Failed to load traders',
    nameRequired: 'Name is required',
    modelRequired: 'AI model is required',
    selectTraders: 'Please select at least one trader',
    adminSaved: 'Admin saved successfully',
    failedToSaveAdmin: 'Failed to save admin',
    failedToLoadAdmins: 'Failed to load administrators',
    adminStarted: 'Administrator started',
    failedToStartAdmin: 'Failed to start administrator',
    adminStopped: 'Administrator stopped',
    failedToStopAdmin: 'Failed to stop administrator',
    confirmDeleteAdmin: 'Are you sure you want to delete this administrator?',
    adminDeleted: 'Administrator deleted',
    failedToDeleteAdmin: 'Failed to delete administrator',
    ...
    scans: 'scans',
    failedToLoadAnalysis: 'Failed to load analysis results',
    noAnalysisData: 'No analysis data yet. Run a scan first.',
    scanSummary: 'Scan Summary',
    scanTime: 'Scan Time',
    tradersAnalyzed: 'Traders Analyzed',
  ...
  zh: {
    ...
    editAdmin: '编辑管理员',
    adminName: '管理员名称',
    enterAdminName: '输入管理员名称',
    scanInterval: '扫描间隔',
    managedTraders: '管理的交易员',
    selectAll: '全选',
    deselectAll: '取消全选',
    noTradersAvailable: '暂无可用交易员',
    selectedCount: '已选择',
    failedToLoadTraders: '加载交易员失败',
    nameRequired: '名称不能为空',
    modelRequired: '请选择AI模型',
    selectTraders: '请至少选择一个交易员',
    adminSaved: '管理员保存成功',
    failedToSaveAdmin: '保存管理员失败',
    failedToLoadAdmins: '加载管理员列表失败',
    adminStarted: '管理员已启动',
    failedToStartAdmin: '启动管理员失败',
    adminStopped: '管理员已停止',
    failedToStopAdmin: '停止管理员失败',
    confirmDeleteAdmin: '确定要删除此管理员吗？',
    adminDeleted: '管理员已删除',
    failedToDeleteAdmin: '删除管理员失败',
    scanCompleted: '扫描完成',
    failedToScan: '运行扫描失败',
    adminUpdated: '管理员已更新',
    adminCreated: '管理员已创建',
    ...
    scans: '次扫描',
    failedToLoadAnalysis: '加载分析结果失败',
    noAnalysisData: '暂无分析数据，请先运行扫描',
    scanSummary: '扫描摘要',
    scanTime: '扫描时间',
    tradersAnalyzed: '已分析交易员',
    hallucinationReport: '幻觉检测报告',
    hallucinationsDetected: '检测到幻觉',
    noIssues: '无问题',
    severity: '严重程度',
    totalIssues: '问题总数',
