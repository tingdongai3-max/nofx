...
export const indicator = {
  ...
  smartFetchHint: { zh: '此处设置传给 AI 的上下文长度，系统会自动拉取更多数据以确保 EMA200 等指标的计算精度。', en: 'This sets the context length sent to AI. The system automatically fetches extra data to keep EMA200-class indicators accurate.', es: 'Esto define la longitud de contexto enviada a la IA. El sistema obtiene datos extra para mantener la precisión de indicadores como EMA200.' },
  ...
  donchianBox: { zh: 'Donchian 盒子', en: 'Donchian Box', es: 'Caja Donchian' },
  donchianBoxDesc: { zh: '趋势过滤因子，显示价格箱体上下边界', en: 'Trend filter factor with box boundaries', es: 'Filtro de tendencia con límites de caja' },
  ...
  netflowRankingDesc: { zh: '大单/小单资金流向', en: 'Large-order/small-order fund flow', es: 'Flujo de órdenes grandes/pequeñas' },
  netflowRankingNote: { zh: '显示大单和小单资金流入/流出排行，帮助比较不同订单规模的流向变化', en: 'Shows inflow/outflow rankings for large-order and small-order flows', es: 'Muestra rankings de flujo para órdenes grandes y pequeñas' },
