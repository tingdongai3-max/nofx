...
export function TraderDashboardPage({
    ...
    // If selectedTrader has no strategy configured, show pending configuration state
    if (selectedTrader && !selectedTrader.strategy_id) {
        return (
            <div className="flex items-center justify-center min-h-[60vh] relative z-10">
                <div className="text-center max-w-md mx-auto px-6">
                    <div
                    ...
                    <h2 className="text-2xl font-bold mb-3 text-nofx-text-main">
                        {t('strategyNotConfigured', language) || '待配置'}
                    </h2>
                    <p className="text-base mb-6 text-nofx-text-muted">
                        {t('strategyNotConfiguredDesc', language) || '请先配置交易策略后再使用交易看板'}
                    </p>
                    <button
                        onClick={onNavigateToTraders}
                        className="px-6 py-3 rounded-lg font-semibold transition-all hover:scale-105 active:scale-95 nofx-glass border border-nofx-gold/30 text-nofx-gold hover:bg-nofx-gold/10"
                    ...
                    <div className="flex items-start justify-between mb-4">
                        <h2 className="text-2xl font-bold flex items-center gap-4 text-nofx-text-main">
                            ...
                            <div className="flex flex-col">
                                ...
                                {status?.is_running && (
                                    <span className="text-xs text-nofx-text-muted mt-1 flex items-center gap-1.5">
                                        <span className="inline-block w-1.5 h-1.5 bg-nofx-green rounded-full animate-pulse" />
                                        {t('deepReasoning', language)}
                                    </span>
                                )}
                            </div>
                        </h2>
